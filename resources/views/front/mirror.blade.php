...
<div class='content'>
    ...
    <div id='JeelizVTOWidget'>
        ...
        <div class='JeelizVTOWidgetControls' id='JeelizVTOWidgetChangeModelContainer'>
            ...
            <button onclick="JEELIZVTOWIDGET.load_modelStandalone('mirrorfile/glasses3D/glasses1.json')">Model 3</button>
            <button onclick="JEELIZVTOWIDGET.load_modelStandalone('glasses3D/glasses2.json')">Model 4</button>
...
<div class="my" style="position: fixed; background: #ddd; top: 10px;"><button type="button" onclick="main()">open camera</button></div>
