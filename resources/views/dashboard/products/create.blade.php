                        ...
                        <form method="POST" action="{{ route('dashboard.products.store')}}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="offer" value="{{old('offer')}}" class="form-control" id="exampleInputOffer" placeholder="Enter Product Offer">
                                </div>
                                @error('price')
                                {{$message}}
                                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="glassesModel" value="{{old('glassesModel')}}" class="custom-file-input" id="exampleInputglassesModel">
                                            <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                                        </div>
                                        <div class="input-group-append">
                                            <span class="input-group-text">Upload</span>
